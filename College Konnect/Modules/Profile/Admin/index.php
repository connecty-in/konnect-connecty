		...
		<div class="container">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              <h3 class="widget-user-username"><?php echo $_SESSION['login_user']; ?></h3>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <a href="javascript:void(0);" onclick="uploadprofile()"><?php echo '<img class="profile-user-img img-responsive img-circle" src="data:image/jpeg;base64,'.base64_encode( $result['profile'] ).'" />'?></a>
